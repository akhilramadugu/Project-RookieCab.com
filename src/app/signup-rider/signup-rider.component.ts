...
@Component({
  ...
  styleUrl: './signup-rider.component.css',
})
export class SignupRiderComponent {
  user_email = '';
  user_password = '';
  ...
  onClickVerify(
    ...
    this.authService
      .checkRiderExists(credentials)
      .subscribe((response: any) => {
        const responseBody = JSON.parse(response.body);
        this.responseMessageExists = responseBody.message;
        console.log(response);
        console.log(this.responseMessageExists);
        if (
          this.responseMessageExists ===
          'Rider already exists with this username'
        ) {
  ...
  getValue(
    ...
    this.authService.createRider(credentials).subscribe((response: any) => {
      const responseBody = JSON.parse(response.body);
